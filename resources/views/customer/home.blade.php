...
<div class="min-h-screen bg-brand-50 font-sans">
    ...
    <div class="sticky top-0 z-30 bg-brand-gradient px-5 pt-5 pb-4 shadow-header rounded-b-3xl">
        ...
        <div class="mt-4 relative">
            <svg xmlns="http://www.w3.org/2000/svg" class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-hint" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mt-4 flex gap-2.5 overflow-x-auto scrollbar-hide pb-1">
            ...
            <a href="/"
               class="flex-shrink-0 px-4 py-2 rounded-pill text-sm font-semibold transition-all
               {{ !$selectedCategory
            ...
            <a href="/?category={{ $category->category_id }}"
               class="flex-shrink-0 px-4 py-2 rounded-pill text-sm font-semibold transition-all whitespace-nowrap
